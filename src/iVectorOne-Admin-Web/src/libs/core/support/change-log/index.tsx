              ...
              <article key={index} className='pt-6'>
                <div className='xl:flex'>
                  ...
                  <div className='grow pb-6 border-b border-slate-200'>
                    <header>
                      <h2 className='text-2xl text-dark-heading font-bold mb-3'>
                        {item.title}
                      </h2>
                      <div className='flex flex-nowrap items-center space-x-2 mb-4'>
                        <div className='flex items-center'>
                          <a
                            className='block text-sm font-semibold text-dark-heading'
                            href='#0'
                          >
                            {item.author}
                          </a>
                    ...
                    <div className='space-y-3 text-dark-heading'>
