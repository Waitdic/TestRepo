    ...
    <Main padding="pb-8">
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <div>
            <div className="mb-5">
              <h2 className="text-xl text-dark-heading font-bold">
                Quick Links
              </h2>
            </div>
            {/* Grid */}
              ...
              <div className="bg-slate-100 rounded-sm text-center p-5">
                <div className="flex flex-col h-full">
                  <div className="grow mb-2">
                    ...
                    {/* Content */}
                    <h3 className="text-lg font-semibold text-dark-heading mb-1">
                      FAQ
                    </h3>
                    <div className="text-sm text-dark-heading"></div>
                    Answers to the most commonly asked iVectorOne questions.
                  </div>
                  {/* Link */}
                  <div>
                    <a
                      ...
                      target="_blank"
                      href="https://ivectorone.intuitivesystems.co.uk/faqs"
                    >
                      View
                    </a>
                  </div>
          ...
          <div>
            <div className="mb-5">
              <h2 className="text-xl text-dark-heading font-bold">Guides</h2>
            </div>
            {/* Grid */}
              ...
              <div className="w-full p-3 rounded-sm text bg-white border border-slate-200">
                <div className="flex h-full">
                  ...
                  <div className="flex flex-col h-full">
                    {/* Content */}
                    <div className="grow mb-2">
                      <div className="font-semibold text-dark-heading mb-1">
                        API Documentation
                      </div>
                      <div className="text-sm text-dark-heading">
