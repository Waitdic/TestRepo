...
const DropdownFilter: React.FC<Props> = ({
  ...
  return (
    <div className='relative inline-flex'>
      <button
        ref={trigger}
        className='btn bg-white border border-gray-300 text-dark hover:bg-gray-50 focus:ring-blue-500'
        aria-haspopup='true'
      ...
      >
        <div ref={dropdown}>
          <div className='text-xs font-semibold text-dark uppercase pt-1.5 pb-2 px-4'>
            {title}
          </div>
          <ul className='mb-4'>
          ...
          <div className='py-2 px-3 border-t border-slate-200 bg-slate-50'>
            <ul className='flex items-center justify-between'>
              <li>
                <button
                  className='btn-xs bg-white border-slate-200 hover:border-slate-300 text-dark'
