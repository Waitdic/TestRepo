              ...
              <article key={idx} className='pt-6'>
                <div className='xl:flex'>
                  <div className='w-32 shrink-0'>
                    <h2 className='text-xl leading-snug font-bold text-dark-heading xl:leading-7 mb-4 xl:mb-0'>
                      {item.title}
                    </h2>
                  </div>
                      ...
                      {item.list.map((listItem, i) => (
                        <li key={i} className='relative py-2'>
                          <div className='flex items-center mb-1'>
                            ...
                            <h3 className='text-lg font-bold text-dark-heading pl-9'>
                              {listItem.title}
                            </h3>
                          </div>
                          <div className='pl-9 text-dark-heading'>
