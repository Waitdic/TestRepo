namespace iVectorOne.SDK.V2.TransferBook
{
    ...
    public class Validator : AbstractValidator<Request>
    {
        public Validator()
        {
            ...
            //    .Must(x => !string.IsNullOrWhiteSpace(x.SupplierReference)).WithMessage(WarningMessages.InvalidRoomSupplierBookingReference)
            //    .Must(x => x.GuestDetails.Any()).WithMessage(WarningMessages.InvalidGuestDetails);
        ...
        //    RuleForEach(x => x.RoomBookings.SelectMany(r => r.GuestDetails))
