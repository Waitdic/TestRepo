namespace ThirdParty.Services
{
    ...
    public interface IPropertyContentService
    {
        ...
        Task<PropertyContent.Response> PropertyContentAsync(List<int> propertyIDs, User user);
        ...
        Task<PropertyList.Response> PropertyListAsync(DateTime? lastModified, string suppliers, User user);
    }
}