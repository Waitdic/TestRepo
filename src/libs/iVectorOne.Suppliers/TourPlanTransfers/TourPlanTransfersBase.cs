    ...
    public abstract class TourPlanTransfersBase : IThirdParty, ISingleSource
    {
        ...
        public async Task<string> BookAsync(TransferDetails transferDetails)
        {
            ...
            try
            {
                ...
                request = await BuildRequestAsync(transferDetails, supplierReferenceValues);
        ...
        private async Task<Request> BuildRequestAsync(TransferDetails transferDetails,
            List<SupplierReferenceData> supplierReferenceData)
        {
            Tuple<SupplierReferenceData, string, string> dynamicLegValues = new Tuple<SupplierReferenceData, string, string>(
                transferDetails.OneWay ? supplierReferenceData.First() : supplierReferenceData.Last(),
                (transferDetails.OneWay ? transferDetails.DepartureDate : transferDetails.ReturnDate).ToString("yyyy-MM-dd"),
                transferDetails.OneWay ? transferDetails.DepartureTime : transferDetails.ReturnTime
                );
