namespace iVectorOne.Service
{
    ...
    using iVectorOne.CSSuppliers.AmadeusHotels;
    ...
    using iVectorOne.CSSuppliers.Hotelston;
    ...
    using iVectorOne.CSSuppliers.Netstorming;
