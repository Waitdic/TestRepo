CREATE PROCEDURE [dbo].[Property_AddAccountProperty]
	@accountId int,
	@source varchar(30),
	@tpKey varchar(50),
	@name nvarchar(320),
...
if exists (select *
			...
			where AccountProperty.AccountID = @accountId) begin
	return
end
...
if (isnull(@centralPropertyId, 0) = 0) begin
	...
	select @centralPropertyId = isnull(max(AccountProperty.CentralPropertyID) + 1, 0)
		from AccountProperty
...
insert into AccountProperty
	select @AccountId, @propertyId, @centralPropertyId